            ...
            <div class="table-container">
                <table id="details">
                    ...
                    <%
                        ...
                        for (Staff e : list) {
                    %>
                    <tr class="editable-row staff-row" data-staff-id="<%= e.getID()%>" data-cust-id="<%= e.getID()%>">
                        <td><%= rowNumber++ %></td>
                        <td><%= e.getID()%></td>
                        <td><%= e.getName()%></td>
                        <td><%= e.getUsername()%></td>
                        ...
                        <td><%= e.getRole()%></td>
                        <td>
                            <button class="edit-btn" onclick="editStaff('<%= e.getID() %>')">Edit</button>
                            <button class="delete-btn" onclick="deleteStaff('<%= e.getID() %>')">Delete</button>
                        </td>
                    </tr>
                    <%
                        }
                ...
                <div class="button-container">
                    <button class="addBtn" type="button" onclick="window.location.href = 'addStaff.jsp';">Add Staff</button>
                </div>
            </div>
        </main>
