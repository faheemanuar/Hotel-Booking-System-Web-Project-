...
<html>
    ...
    <body>
        <header>
            ...
            <nav>
                <ul>
                    <li><a href="addCust.jsp" class="button">Register</a></li>
                    <li><a href="LoginUser.jsp" class="button">Sign In</a></li>
                </ul>   
            </nav>
        </header>
    ...
    <div class="listing">
        ...
        <%
            ...
            for (Room room : rooms) {
                ...
                String price = "Rm80 only!"; // Default price if not matched

                // Set price based on room type
                if (roomType.equals("Deluxe Twin")) {
                    price = "RM80 for booking";
