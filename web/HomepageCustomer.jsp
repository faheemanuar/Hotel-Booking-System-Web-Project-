    ...
    <body>
        <header>
            ...
            <nav>
                <ul>
                    <!--                    <li class="dropdown">
                                        <button class="dropbtn">BOOK ROOM</button>
                                        <div class="dropdown-content">
                                            ...
                                            <li class="dropdown">
                                            <button class="dropbtn">TYPE ROOM</button>
                                            <div class="dropdown-content">
                                                <a href="">Deluxe Twin</a>
                                                <a href="">Deluxe Queen</a>
                    ...
                    <li><a href="viewBooking.jsp" class="button">View Booking</a></li>
                </ul>   
            </nav>
        </header>
